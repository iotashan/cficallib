<cfcomponent hint="I am a VTODO iCal Component" extends="iCalComponent" output="false">
	<!--- identifying fields --->
	...
	<!--- time fields --->
	<cfproperty name="due" type="date" required="no" hint="The timestamp when this starts" />
	...
	<cfproperty name="percentComplete" type="numeric" required="no" hint="0-100" />
	...
	<cffunction name="setdue">
		<cfargument name="due" type="date" />
	
		<cfset THIS.due = ARGUMENTS.due />
	</cffunction>

	<cffunction name="getdue">
		<cfreturn THIS.due />
	</cffunction>
	...
	<cffunction name="setcompleted">
		<cfargument name="completed" type="date" />
	
		<cfset THIS.completed = ARGUMENTS.completed />
	</cffunction>

	<cffunction name="getcompleted">
		<cfreturn THIS.completed />
	</cffunction>
	...
	<cffunction name="setpercentComplete">
		<cfargument name="percentComplete" type="numeric" />
	
		<cfset THIS.percentComplete = ARGUMENTS.percentComplete />
	</cffunction>

	<cffunction name="getpercentComplete">
		<cfreturn THIS.percentComplete />
	</cffunction>
	...
	<cffunction name="buildcomponent" returntype="string">
		...
		<cfif isDefined("THIS.due")>
			<cfset ret = ret & "DTSTART#tzidParam()#:" & icalDateTimeFormat(THIS.due,THIS.tzid,THIS.isUTC) & crlf />
		</cfif>
		...
		<cfif isDefined("THIS.percentComplete")>
			<cfset ret = ret & "PERCENT-COMPLETE:" & THIS.percentComplete & crlf />
		</cfif>
